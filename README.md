...
<ul>
  <li>Python, React, Typescript, Tailwind</li>
  <li>Framer Motion (Animations)</li>
  <li>Figma, Procreate, Notability, Notion</li>
...
<ul>
  ...
  <li>📊 Love building data analysis applications & dashboards</li>
  <li>💻 Getting into Web Design</li>
</ul>
<!--
